// Package migrations embeds and applies UserHub Service PostgreSQL schema migrations.
package migrations
...
// Up applies all pending UserHub Service migrations to PostgreSQL.
...
// Down rolls back the most recently applied UserHub Service migration.
